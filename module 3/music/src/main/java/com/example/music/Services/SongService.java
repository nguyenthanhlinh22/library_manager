...
public class SongService {
    ...
    public int getSongCount(HttpServletRequest request, HttpServletResponse response) throws SQLException {
    ...
    public void renderListSong(HttpServletRequest req, HttpServletResponse res) throws SQLException, ServletException, IOException {
        ...
        int totalSongs = this.getSongCount(req,res);
        req.setAttribute("totalSongs", totalSongs);
